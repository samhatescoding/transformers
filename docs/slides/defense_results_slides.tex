...
\begin{frame}{21-Benchmark Study: Performance vs. CPU RAM}
\begin{center}
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\assetpath/study21_clean_perf_vs_cpu_ram.png}
\end{center}
\end{frame}

\begin{frame}{21-Benchmark Study: Performance vs. Error Rate}
\begin{center}
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\assetpath/study21_clean_perf_vs_error_rate.png}
\end{center}
\end{frame}
...
\begin{frame}{44-Benchmark Full: Lowest Token Price}
\begin{center}
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\assetpath/full44_lowest_price_per_token.png}
\end{center}
\end{frame}

\begin{frame}{44-Benchmark Full: Parameter Counts}
\begin{center}
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\assetpath/full44_parameter_counts_publicly_undisclosed.png}
\end{center}
\end{frame}
