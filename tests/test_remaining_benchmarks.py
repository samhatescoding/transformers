...
class RemainingBenchmarkTests(unittest.TestCase):
    def test_remaining_benchmarks_run_on_stub_datasets(self) -> None:
        cases = [
            ...
            (BLIP3o60kBenchmark, _ChoiceDataset("blip3o_60k", [{"source_image": _square("red"), "target_image": _square("green"), "question": "Which edit happened?", "choices": ["change the object to green", "add a tree"], "answer": "change the object to green"}]), _PromptAwareModel("A")),
