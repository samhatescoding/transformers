...
class Llava(AutoProcessorModelBase):
    display_name = "LLaVA"
    model_loader = LlavaForConditionalGeneration.from_pretrained
    ...
    def _prepare_prompt(self, prompt: str) -> str:
        ...
        instruction = self._extract_prompt(raw_prompt)
